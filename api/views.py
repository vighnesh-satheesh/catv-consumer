    ...
    def get(self, request, format=None):
        ...
        with connection.cursor() as cursor:
            ...
            if org_cases:
                ...
                cursor.execute(
                    Constants.QUERIES['SELECT_LEFT_PANEL_VALUES_CASE_ORG'].format(users))
        ...
        with connection.cursor() as cursor:
            if lpv:
                ...
                if user.permission is UserPermission.SUPERSENTINEL or \
                    ...
                    sql = Constants.QUERIES['SELECT_CASE_INDICATOR_COUNT'] % (
                        "'released'", "'confirmed'",)
...
class CaseFilter(filters.FilterSet):
    ...
    def filter_case_board(self, queryset, name, value):
        ...
        if cate == "all":
            ...
            case_filter &= (Q(owner=self.request.user.pk) |
    ...
    def delete(self, request, pk=None):
        ...
        try:
            with transaction.atomic():
                ...
                indicator_ids = [
                    case_m2m.indicator_id for case_m2m in case_m2m_queryset]
...
class IndicatorView(generics.ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if api_settings.SWITCH_ES_SEARCH and core_ftr.children:
            ...
            if total_items == 0:
                total_items = self.model.objects.filter(
                    ftr).distinct('id').count()
