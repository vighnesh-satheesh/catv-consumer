...
env = environ.Env()
env_path = os.environ.get('CATV_CONSUMER_API_ENV_PATH')
if env_path and os.path.exists(env_path):
    env.read_env(env.str('CATV_CONSUMER_API_ENV_PATH', '.env'))

ENVIRONMENT = env.str('CATV_CONSUMER_API_ENV_PATH', 'development')
...
DEFAULT_FILE_STORAGE = "api.storages.gcs.GCSStorage"
...
API_SETTINGS = {
    ...
    "CATV_TX_LIMIT": env.int("API_CATV_TX_LIMIT", 20000),
    ...
    "GRAPHQL_ACCESS_TOKEN": env.str("GRAPHQL_ACCESS_TOKEN", "ory_at_KiQuxPGTWws2zxjp-N73sqXtju5vMAMKJsBGLj-5-qs.bVoYVpClHnBhymv5OjwWrxrb2PvwULz0uvI-xCQGYuU"),
...
BLOXY_BTC_SRC_ENDPOINT = env.str('API_BLOXY_BTC_SRC_ENDPOINT', 'https://ctds.api.bitquery.io/bitcoin:coinpath/inbound_graph')
BLOXY_LTC_SRC_ENDPOINT = env.str('API_BLOXY_LTC_SRC_ENDPOINT', 'https://sentinel.api.bitquery.io/bitcoin:coinpath/inbound_graph')
BLOXY_BTC_DIST_ENDPOINT = env.str('API_BLOXY_BTC_DIST_ENDPOINT', 'https://ctds.api.bitquery.io/bitcoin:coinpath/outbound_graph')
BLOXY_LTC_DIST_ENDPOINT = env.str('API_BLOXY_LTC_DIST_ENDPOINT', 'https://sentinel.api.bitquery.io/bitcoin:coinpath/outbound_graph')
...
BLOXY_ETH_DIST_ENDPOINT = env.str('API_BLOXY_ETH_DIST_ENDPOINT', 'https://ctds.api.bitquery.io/sentinel/outbound_graph_with_stat')
BLOXY_KLAY_DIST_ENDPOINT = env.str('API_BLOXY_KLAY_DIST_ENDPOINT', 'https://sentinel.api.bitquery.io/sentinel/outbound_graph_with_stat')
BLOXY_ETH_SRC_ENDPOINT = env.str('API_BLOXY_ETH_SRC_ENDPOINT', 'https://ctds.api.bitquery.io/sentinel/inbound_graph_with_stat')
BLOXY_KLAY_SRC_ENDPOINT = env.str('API_BLOXY_KLAY_SRC_ENDPOINT', 'https://sentinel.api.bitquery.io/sentinel/inbound_graph_with_stat')
...
RABBIT_MQ_HOST=API_SETTINGS['RABBIT_MQ_HOST']

# GRAPHQL
GRAPHQL_ENDPOINT = API_SETTINGS["GRAPHQL_ENDPOINT"]
GRAPHQL_X_API_KEY = API_SETTINGS["GRAPHQL_X_API_KEY"]
GRAPHQL_ACCESS_TOKEN = API_SETTINGS["GRAPHQL_ACCESS_TOKEN"]
